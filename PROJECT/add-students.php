                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Fill student information</h5>
                                                </div>
                                            </div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Exam Roll Number</label>
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" required="required">
</div>
</div>
